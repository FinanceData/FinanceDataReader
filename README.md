...
또는 [uv](https://docs.astral.sh/uv/)를 사용하는 경우:
...
fdr price FRED:DEXKOUS -s 2020             # FRED 달러/원 환율
fdr price USD/KRW -s 2024                  # 달러 원화 환율
```
...
fdr price AAPL -s 2024 -f markdown         # Markdown 테이블
